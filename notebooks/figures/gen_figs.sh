...
python3 ${base}/simple_automata.py
...
python3 ${base}/epsilon_intersect.py

ef=epsilon_intersect_both
for f in "_1" "_2" "" "_correct"
do
    dot -Tsvg ${base}/${ef}${f}.dot -o ${base}/${ef}${f}.svg
done
...
do
    ...
    do
        ...
        dot -Tsvg ${base}/intersect_steps/${gf}.dot -o ${base}/${gf}.svg
    done
done
...
do
    dot -Tsvg ${base}/${f}.dot -o ${base}/${f}.svg
done
